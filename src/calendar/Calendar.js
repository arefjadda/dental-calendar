...
class Calendar extends Component {
  ...
  addNewEvent = (event) => {
    event = {
      ...event,
      id: EventHandler.generateId(event)
    };
    this.setState((previousState) => ({
      events: EventHandler.add(previousState.events, event)
    }));
  };
  ...
  updateEvent = (eventId, updatedEvent) => {
    this.setState((previousState) => {
      return {
        events: EventHandler.update(eventId, updatedEvent, previousState.events)
      };
    });
  };
  ...
  deleteEvent = (eventId) => {
    this.setState((previousState) => {
      return {
        events: EventHandler.delete(eventId, previousState.events)
      };
    });
  };
